...
//                 socialPlatform = SOCIAL_DOMAINS[domain];
//                 break;
//             }
//         }
//     } catch { }
...
//             method: "POST",
//             headers: {
//                 "X-API-KEY": "5b4d63ddc1f2ca7b1f4114a27313e64bdd9f6f9a",
...
//         const leads = organic.map(extractLeadData);

//         return NextResponse.json({ leads, query: searchQuery });
//     } catch (err) {
